...
function ModuleActivationDisplay({
  modules,
  isActive,
  isActivating,
...
export function PlanActivationFlow() {
  const { upgradePlan, getPlan } = useSystemState();
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-cyan-300">
                Configuring Compliance Engine...
              </h3>
              <p className="text-sm text-cyan-400/70">
                Activating modules and permissions
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-amber-400/70 mt-1">
                You have access to core features. Select a plan to unlock all
                modules and remove trial limitations.
              </p>
            </div>
          </div>
        </div>
