...
const VIEW_MAP = Object.fromEntries(VIEWS.map((v) => [v.id, v])) as Record<
  ViewId,
  ViewMeta
>;
...
const TASKS: TaskItem[] = [
  {
    id: 'T01',
    title: 'Review SOC 2 Type II controls',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'AK',
    due: 'Feb 28',
  ...
  {
    id: 'T02',
    title: 'Upload penetration test report',
    status: 'Pending',
    cls: B.pend,
    assignee: 'SM',
    due: 'Mar 1',
  ...
  {
    id: 'T03',
    title: 'Map ISO 27001 Annex A controls',
    status: 'Complete',
    cls: B.done,
    assignee: 'JR',
    due: 'Feb 15',
  ...
  {
    id: 'T08',
    title: 'Update BCP documentation',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'SM',
    due: 'Mar 15',
  ...
  {
    id: 'T09',
    title: 'Review firewall change requests',
    status: 'Complete',
    cls: B.done,
    assignee: 'TP',
    due: 'Feb 12',
  ...
  {
    id: 'T11',
    title: 'Validate backup restore procedures',
    status: 'Pending',
    cls: B.pend,
    assignee: 'LW',
    due: 'Mar 8',
  ...
  {
    id: 'T12',
    title: 'Remediate vulnerability scan findings',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'AK',
    due: 'Feb 25',
  ...
  {
    id: 'T14',
    title: 'Update endpoint protection config',
    status: 'Complete',
    cls: B.done,
    assignee: 'TP',
    due: 'Feb 8',
  ...
  {
    id: 'T15',
    title: 'Review third-party SLA agreements',
    status: 'Pending',
    cls: B.pend,
    assignee: 'NM',
    due: 'Mar 12',
  ...
  {
    id: 'T16',
    title: 'Conduct tabletop IR exercise',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'JR',
    due: 'Mar 1',
  ...
  {
    id: 'T17',
    title: 'Evaluate SIEM alert thresholds',
    status: 'In Review',
    cls: B.rev,
    assignee: 'LW',
    due: 'Feb 20',
  ...
  {
    id: 'T18',
    title: 'Complete NDIS audit preparation',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'AK',
    due: 'Mar 5',
  ...
  {
    id: 'T19',
    title: 'Update asset classification matrix',
    status: 'Pending',
    cls: B.pend,
    assignee: 'SM',
    due: 'Mar 15',
  ...
  {
    id: 'T20',
    title: 'Review password policy compliance',
    status: 'Complete',
    cls: B.done,
    assignee: 'TP',
    due: 'Feb 18',
  ...
  {
    id: 'T21',
    title: 'Map Essential Eight maturity level',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'NM',
    due: 'Feb 28',
  ...
  {
    id: 'T22',
    title: 'Audit privileged access accounts',
    status: 'Overdue',
    cls: B.over,
    assignee: 'JR',
    due: 'Feb 5',
  ...
  {
    id: 'T23',
    title: 'Update network segmentation docs',
    status: 'Draft',
    cls: B.draft,
    assignee: 'LW',
    due: 'Mar 10',
  ...
  {
    id: 'T24',
    title: 'Review DLP rule effectiveness',
    status: 'Pending',
    cls: B.pend,
    assignee: 'AK',
    due: 'Mar 8',
  ...
  {
    id: 'T25',
    title: 'Prepare for external ISO audit',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'SM',
    due: 'Mar 20',
  ...
  {
    id: 'T26',
    title: 'Test disaster recovery runbook',
    status: 'In Review',
    cls: B.rev,
    assignee: 'TP',
    due: 'Feb 22',
  ...
  {
    id: 'T27',
    title: 'Implement MFA for remaining admins',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'NM',
    due: 'Feb 25',
  ...
  {
    id: 'T28',
    title: 'Document data flow diagrams',
    status: 'Pending',
    cls: B.pend,
    assignee: 'JR',
    due: 'Mar 12',
  ...
  {
    id: 'T29',
    title: 'Review cloud security configurations',
    status: 'Complete',
    cls: B.done,
    assignee: 'LW',
    due: 'Feb 14',
  ...
  {
    id: 'T30',
    title: 'Conduct vendor security questionnaire',
    status: 'In Progress',
    cls: B.prog,
    assignee: 'AK',
    due: 'Mar 1',
...
const EVIDENCE: EvidenceItem[] = [
  ...
  {
    id: 'E02',
    name: 'PenTest-Report-External.pdf',
    type: 'PDF',
    size: '5.1 MB',
    date: 'Feb 10',
    tag: 'SOC 2',
  ...
  {
    id: 'E03',
    name: 'AccessReview-Jan2026.xlsx',
    type: 'XLSX',
    size: '890 KB',
    date: 'Feb 8',
    tag: 'Access',
  ...
  {
    id: 'E04',
    name: 'IncidentResponse-Runbook-v3.md',
    type: 'MD',
    size: '124 KB',
    date: 'Feb 5',
    tag: 'IR',
  ...
  {
    id: 'E05',
    name: 'VendorDueDiligence-Stripe.pdf',
    type: 'PDF',
    size: '1.8 MB',
    date: 'Feb 1',
    tag: 'Vendor',
  ...
  {
    id: 'E06',
    name: 'DataClassification-Matrix.xlsx',
    type: 'XLSX',
    size: '340 KB',
    date: 'Jan 28',
    tag: 'Data',
  ...
  {
    id: 'E07',
    name: 'SecurityAwareness-Completion.csv',
    type: 'CSV',
    size: '56 KB',
    date: 'Jan 25',
    tag: 'Training',
  ...
  {
    id: 'E08',
    name: 'FirewallConfig-Prod-v12.json',
    type: 'JSON',
    size: '18 KB',
    date: 'Jan 22',
    tag: 'Network',
  ...
  {
    id: 'E09',
    name: 'BackupRestoreTest-Jan2026.pdf',
    type: 'PDF',
    size: '1.2 MB',
    date: 'Jan 20',
    tag: 'BCP',
  ...
  {
    id: 'E10',
    name: 'EndpointProtection-Dashboard.png',
    type: 'PNG',
    size: '445 KB',
    date: 'Jan 18',
    tag: 'Endpoint',
  ...
  {
    id: 'E11',
    name: 'ISO27001-CertificateOfCompliance.pdf',
    type: 'PDF',
    size: '820 KB',
    date: 'Jan 15',
    tag: 'ISO 27001',
  ...
  {
    id: 'E12',
    name: 'ChangeManagement-Log-Q4.xlsx',
    type: 'XLSX',
    size: '1.5 MB',
    date: 'Jan 12',
    tag: 'Change',
  ...
  {
    id: 'E13',
    name: 'VulnScan-Results-Feb2026.pdf',
    type: 'PDF',
    size: '3.2 MB',
    date: 'Feb 12',
    tag: 'Vuln',
  ...
  {
    id: 'E14',
    name: 'SIEM-AlertSummary-Weekly.pdf',
    type: 'PDF',
    size: '780 KB',
    date: 'Feb 9',
    tag: 'SIEM',
  ...
  {
    id: 'E15',
    name: 'MFA-EnrollmentStatus.xlsx',
    type: 'XLSX',
    size: '210 KB',
    date: 'Feb 7',
    tag: 'Access',
  ...
  {
    id: 'E16',
    name: 'PhishingSimulation-Results.pdf',
    type: 'PDF',
    size: '1.1 MB',
    date: 'Feb 4',
    tag: 'Training',
  ...
  {
    id: 'E17',
    name: 'NetworkDiagram-Prod-v8.vsdx',
    type: 'VSDX',
    size: '2.8 MB',
    date: 'Feb 1',
    tag: 'Network',
  ...
  {
    id: 'E18',
    name: 'DLP-PolicyViolations-Jan.csv',
    type: 'CSV',
    size: '92 KB',
    date: 'Jan 30',
    tag: 'DLP',
  ...
  {
    id: 'E19',
    name: 'CloudSecurityPosture-AWS.pdf',
    type: 'PDF',
    size: '4.5 MB',
    date: 'Jan 27',
    tag: 'Cloud',
  ...
  {
    id: 'E20',
    name: 'PrivilegedAccess-Audit-Q4.xlsx',
    type: 'XLSX',
    size: '670 KB',
    date: 'Jan 24',
    tag: 'Access',
  ...
  {
    id: 'E21',
    name: 'DisasterRecovery-TestResults.pdf',
    type: 'PDF',
    size: '2.1 MB',
    date: 'Jan 21',
    tag: 'BCP',
  ...
  {
    id: 'E22',
    name: 'ThirdPartyRisk-Assessment-Acme.pdf',
    type: 'PDF',
    size: '1.4 MB',
    date: 'Jan 18',
    tag: 'Vendor',
  ...
  {
    id: 'E23',
    name: 'DataFlowDiagram-CustomerData.pdf',
    type: 'PDF',
    size: '960 KB',
    date: 'Jan 15',
    tag: 'Data',
  ...
  {
    id: 'E24',
    name: 'PatchManagement-Status-Feb.xlsx',
    type: 'XLSX',
    size: '380 KB',
    date: 'Feb 11',
    tag: 'Patch',
  ...
  {
    id: 'E25',
    name: 'BoardReport-Compliance-Q4.pdf',
    type: 'PDF',
    size: '3.8 MB',
    date: 'Jan 10',
    tag: 'Board',
  ...
  {
    id: 'E26',
    name: 'EncryptionStandards-Review.md',
    type: 'MD',
    size: '86 KB',
    date: 'Jan 8',
    tag: 'Crypto',
  ...
  {
    id: 'E27',
    name: 'AssetInventory-Complete-2026.xlsx',
    type: 'XLSX',
    size: '1.9 MB',
    date: 'Jan 5',
    tag: 'Assets',
  ...
  {
    id: 'E28',
    name: 'NDIS-PracticeStandards-Map.pdf',
    type: 'PDF',
    size: '2.6 MB',
    date: 'Jan 2',
    tag: 'NDIS',
  ...
  {
    id: 'E29',
    name: 'EssentialEight-MaturityAssessment.pdf',
    type: 'PDF',
    size: '1.7 MB',
    date: 'Dec 28',
    tag: 'E8',
  ...
  {
    id: 'E30',
    name: 'PasswordPolicy-Compliance-Scan.csv',
    type: 'CSV',
    size: '145 KB',
    date: 'Dec 25',
    tag: 'Access',
  ...
  {
    id: 'E31',
    name: 'LogRetention-Configuration.json',
    type: 'JSON',
    size: '12 KB',
    date: 'Dec 22',
    tag: 'Logging',
  ...
  {
    id: 'E33',
    name: 'UserAccessMatrix-Production.xlsx',
    type: 'XLSX',
    size: '520 KB',
    date: 'Dec 18',
    tag: 'Access',
  ...
  {
    id: 'E34',
    name: 'SecurityIncident-IR2026-001.pdf',
    type: 'PDF',
    size: '890 KB',
    date: 'Dec 15',
    tag: 'IR',
  ...
  {
    id: 'E35',
    name: 'ComplianceTraining-Transcripts.zip',
    type: 'ZIP',
    size: '8.4 MB',
    date: 'Dec 12',
    tag: 'Training',
  ...
  {
    id: 'E37',
    name: 'VendorSecurityQuestionnaire-AWS.pdf',
    type: 'PDF',
    size: '1.6 MB',
    date: 'Dec 8',
    tag: 'Vendor',
  ...
  {
    id: 'E38',
    name: 'DatabaseEncryption-AuditLog.csv',
    type: 'CSV',
    size: '230 KB',
    date: 'Dec 5',
    tag: 'Crypto',
  ...
  {
    id: 'E39',
    name: 'MobileDevice-ManagementPolicy.pdf',
    type: 'PDF',
    size: '740 KB',
    date: 'Dec 3',
    tag: 'MDM',
  ...
  {
    id: 'E40',
    name: 'ContainerSecurity-ScanResults.pdf',
    type: 'PDF',
    size: '3.1 MB',
    date: 'Dec 1',
    tag: 'Cloud',
...
const REPORTS: ReportItem[] = [
  ...
  {
    id: 'R02',
    name: 'SOC 2 Type II Gap Analysis',
    status: 'Draft',
    cls: B.draft,
    date: 'Feb 12',
    pages: 18,
  ...
  {
    id: 'R05',
    name: 'Quarterly Compliance Digest',
    status: 'Final',
    cls: B.done,
    date: 'Jan 31',
    pages: 16,
  ...
  {
    id: 'R07',
    name: 'Essential Eight Maturity Report',
    status: 'Draft',
    cls: B.draft,
    date: 'Jan 20',
    pages: 14,
  ...
  {
    id: 'R09',
    name: 'Security Posture Executive Summary',
    status: 'In Review',
    cls: B.rev,
    date: 'Jan 10',
    pages: 6,
  ...
  {
    id: 'R11',
    name: 'NDIS Compliance Status Report',
    status: 'Draft',
    cls: B.draft,
    date: 'Dec 28',
    pages: 11,
  ...
  {
    id: 'R12',
    name: 'Annual Risk Assessment Summary',
    status: 'Final',
    cls: B.done,
    date: 'Dec 22',
    pages: 28,
  ...
  {
    id: 'R13',
    name: 'Penetration Test Executive Brief',
    status: 'Final',
    cls: B.done,
    date: 'Dec 18',
    pages: 7,
...
const RISKS: RiskItem[] = [
  {
    id: 'RK01',
    name: 'Unpatched CVE in auth service',
    sev: 'Critical',
    cls: B.crit,
  ...
  {
    id: 'RK03',
    name: 'Missing MFA for 2 admin accounts',
    sev: 'High',
    cls: B.high,
  ...
  {
    id: 'RK07',
    name: 'Third-party API without rate limiting',
    sev: 'Medium',
    cls: B.med,
    dotCls: 'bg-amber-400/70',
    age: '10d',
  ...
  {
    id: 'RK10',
    name: 'Incomplete data classification',
    sev: 'Low',
    cls: B.low,
    dotCls: 'bg-emerald-400/70',
    age: '21d',
  ...
  {
    id: 'RK12',
    name: 'Privileged account without audit trail',
    sev: 'Critical',
    cls: B.crit,
    dotCls: 'bg-red-400/70',
    age: '4d',
  ...
  {
    id: 'RK14',
    name: 'Outdated incident response contacts',
    sev: 'Low',
    cls: B.low,
    dotCls: 'bg-emerald-400/70',
    age: '30d',
  ...
  {
    id: 'RK15',
    name: 'Weak password policy for contractors',
    sev: 'Medium',
    cls: B.med,
    dotCls: 'bg-amber-400/70',
    age: '15d',
  ...
  {
    id: 'RK16',
    name: 'Unsegmented guest WiFi network',
    sev: 'High',
    cls: B.high,
    dotCls: 'bg-orange-400/70',
    age: '9d',
  ...
  {
    id: 'RK19',
    name: 'Incomplete DR test documentation',
    sev: 'Low',
    cls: B.low,
    dotCls: 'bg-emerald-400/70',
    age: '20d',
  ...
  {
    id: 'RK20',
    name: 'Missing DPIA for new CRM system',
    sev: 'Medium',
    cls: B.med,
    dotCls: 'bg-amber-400/70',
    age: '11d',
...
function sortItems<T>(items: T[], sort: SortOption): T[] {
  ...
  const sorted = [...items];
  if (sort === 'name-asc')
    sorted.sort((a, b) => getTextField(a).localeCompare(getTextField(b)));
  if (sort === 'name-desc')
    sorted.sort((a, b) => getTextField(b).localeCompare(getTextField(a)));
  if (sort === 'status')
    sorted.sort((a, b) =>
      ((a as AnyItem)?.status ?? '').localeCompare(
        (b as AnyItem)?.status ?? '',
      ),
    );
  return sorted;
          ...
          >
            ...
            {data.status && (
              <div className="px-5 py-3 border-b border-white/[0.06] shrink-0">
                <span
                  className={`text-xs px-2.5 py-1 rounded-full ${data.statusCls}`}
                >
                  {data.status}
                </span>
              </div>
            ...
            <div className="flex gap-2 px-5 py-3 border-t border-white/[0.06] shrink-0">
              ...
              <button
                onClick={() => {
                  onAction('Exported successfully');
                  onClose();
                }}
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 mb-4 shrink-0">
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-[10px] text-white/35 bg-white/[0.05] px-2 py-0.5 rounded-md font-medium">
          {count}
        </span>
      </div>
      <div className="flex items-center gap-2 w-full sm:w-auto">
        ...
        <button
          onClick={onExport}
          className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.07] text-white/35 hover:text-white/55 hover:bg-white/[0.06] transition-colors"
          title="Export"
        >
        ...
        <button
          onClick={onNew}
          className="p-2 rounded-lg bg-teal-400/10 border border-teal-400/20 text-teal-300 hover:bg-teal-400/15 transition-colors"
          title="New"
        >
...
const ROW_BASE =
  'flex items-center gap-3 rounded-xl bg-white/[0.02] border border-white/[0.06] px-4 py-3 hover:bg-white/[0.05] hover:border-white/[0.10] transition-all cursor-pointer focus:outline-none focus-visible:ring-1 focus-visible:ring-teal-400/40';
  ...
  switch (viewId) {
    case 'tasks':
      return {
        ...
        details: [
          ...baseDetails,
          { label: 'Assigned To', value: item.assignee as string },
          { label: 'Due Date', value: item.due as string },
          {
            label: 'Description',
            value:
              'Review and validate all related control mappings. Ensure evidence artifacts are linked and up to date. Coordinate with control owners for sign-off.',
          },
        ],
      };
    case 'evidence':
      return {
        ...
        details: [
          ...baseDetails,
          { label: 'File Type', value: item.type as string },
          { label: 'File Size', value: item.size as string },
          { label: 'Uploaded', value: item.date as string },
          { label: 'Framework', value: item.tag as string },
          { label: 'Linked Controls', value: '3 controls linked' },
        ],
      };
    case 'controls':
      return {
        ...
        details: [
          ...baseDetails,
          { label: 'Control Code', value: item.code as string },
          { label: 'Framework', value: item.framework as string },
          { label: 'Evidence Items', value: '5 artifacts linked' },
          { label: 'Last Reviewed', value: 'Feb 10, 2026' },
        ],
      };
    case 'reports':
      return {
        ...
        details: [
          ...baseDetails,
          { label: 'Generated', value: item.date as string },
          { label: 'Pages', value: String(item.pages) },
          { label: 'Format', value: 'PDF' },
          { label: 'Recipients', value: 'Board of Directors, CISO' },
        ],
      };
    case 'risk':
      return {
        ...
        status: item.sev as string,
        statusCls: item.cls as string,
        details: [
          ...baseDetails,
          { label: 'Severity', value: item.sev as string },
          { label: 'Age', value: item.age as string },
          { label: 'Owner', value: item.owner as string },
          {
            label: 'Mitigation',
            value:
              'Remediation plan in progress. Target resolution within SLA window. Escalation path defined.',
          },
        ],
      };
    case 'policies':
      return {
        title,
        subtitle: `${item.ver} · ${item.owner}`,
        status: status as string,
        statusCls: statusCls as string,
        details: [
          ...baseDetails,
          { label: 'Version', value: item.ver as string },
          { label: 'Owner', value: item.owner as string },
          { label: 'Last Review', value: item.review as string },
...
export function ProductLiveDemo() {
  ...
  const handleSidebarKeyDown = useCallback(
    (e: React.KeyboardEvent, idx: number) => {
      if (e.key === 'ArrowDown') {
        ...
        if (next) switchView(next.id);
      }
      if (e.key === 'ArrowUp') {
        e.preventDefault();
        const prev = VIEWS[idx - 1];
        if (prev) switchView(prev.id);
      }
    },
    [switchView],
  );
  ...
  const filteredTasks = useMemo(
    () => sortItems(filterItems(TASKS, search), sort),
    [search, sort],
  );
  const filteredEvidence = useMemo(
    () => sortItems(filterItems(EVIDENCE, search), sort),
    [search, sort],
  );
  const filteredControls = useMemo(
    () => sortItems(filterItems(CONTROLS, search), sort),
    [search, sort],
  );
  const filteredReports = useMemo(
    () => sortItems(filterItems(REPORTS, search), sort),
    [search, sort],
  );
  const filteredRisks = useMemo(
    () => sortItems(filterItems(RISKS, search), sort),
    [search, sort],
  );
  const filteredPolicies = useMemo(
    () => sortItems(filterItems(POLICIES, search), sort),
    [search, sort],
  );
  ...
  const renderContent = () => {
    if (activeView === 'dashboard') {
      return (
        <div className="flex flex-col h-full">
          ...
          <div className="text-[10px] text-white/30 font-medium uppercase tracking-wider mb-2.5 shrink-0">
            Active Tasks
          </div>
          <div
          ...
          >
            {TASKS.slice(0, 8).map((t) => (
              ...
              >
                ...
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full shrink-0 ${t.cls}`}
                >
                  {t.status}
                </span>
              </button>
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        >
          {items.length === 0 && (
            <div className="text-xs text-white/25 text-center py-8">
          ...
          {activeView === 'tasks' &&
            filteredTasks.map((t) => (
              ...
              >
                ...
                <span className="text-[10px] text-white/25 shrink-0 hidden sm:inline">
                  {t.due}
                </span>
                <div className="w-5 h-5 rounded-full bg-white/[0.05] flex items-center justify-center shrink-0">
                  <span className="text-[9px] font-semibold text-white/40">
          ...
          {activeView === 'evidence' &&
            filteredEvidence.map((e) => (
              ...
              >
                ...
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-amber-400/12 text-amber-300 shrink-0">
                  {e.tag}
                </span>
              </button>
            ))}
          {activeView === 'controls' &&
            filteredControls.map((c) => (
              <button
                ...
                type="button"
                className={ROW_BASE + ' w-full text-left'}
                onClick={() => openDetail('controls', c)}
              >
                <span className="text-[10px] font-mono text-emerald-300/80 w-10 shrink-0">
                  {c.code}
                </span>
                ...
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full shrink-0 ${c.cls}`}
                >
                  {c.status}
                </span>
              </button>
          ...
          {activeView === 'reports' &&
            filteredReports.map((r) => (
              ...
              >
                ...
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full shrink-0 ${r.cls}`}
                >
                  {r.status}
                </span>
              </button>
          ...
          {activeView === 'policies' &&
            filteredPolicies.map((p) => (
              <button
                ...
                type="button"
                className={ROW_BASE + ' w-full text-left'}
                onClick={() => openDetail('policies', p)}
              >
                <div className="w-6 h-6 rounded bg-rose-400/10 flex items-center justify-center shrink-0">
                  <BookOpen className="w-3 h-3 text-rose-300" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-xs text-white/60 truncate">{p.name}</div>
                  <div className="text-[10px] text-white/20">
                    {p.ver} · {p.review} · {p.owner}
                  </div>
                </div>
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full shrink-0 ${p.cls}`}
                >
                  {p.status}
                </span>
              </button>
      ...
      <div className="absolute inset-0 flex flex-col overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
              ...
              >
                {VIEWS.map((v, idx) => {
                  ...
                  return (
                    ...
                    >
                      <VIcon
                        className={`w-3.5 h-3.5 ${isActive ? 'opacity-90' : 'opacity-60'}`}
                      />
          ...
          >
            ...
            {isMobile && (
              <div
                className="flex gap-1.5 px-2.5 py-2 border-b border-white/[0.06] overflow-x-auto shrink-0 sm:px-3"
                ...
                {activeView === 'dashboard' && (
                  <>
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-white/[0.03] border border-white/[0.07] text-[10px] text-white/35 hover:bg-white/[0.06] transition-colors"
                    >
                      Export
                    </button>
                    <button
                      onClick={handleNew}
                      className="px-2.5 py-1 rounded-lg bg-cyan-500/12 border border-cyan-500/20 text-[10px] text-cyan-300 hover:bg-cyan-500/18 transition-colors"
                    >
                      + New
                    </button>
                  </>
