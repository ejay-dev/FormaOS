...
export default function DemoTopBar() {
  ...
  return (
    <div className="flex h-10 items-center justify-between border-b border-white/[0.06] bg-[#0f1729]/60 px-4">
      {/* Search */}
      <div className="flex items-center gap-2 rounded-md bg-white/[0.04] px-2.5 py-1 text-[11px] text-muted-foreground/60 min-w-0 max-w-[220px] w-full">
      ...
      <div className="flex items-center gap-3">
        {/* Org name */}
        <span className="hidden sm:block text-[11px] text-muted-foreground truncate max-w-[140px]">
          {demoOrg.name}
        </span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="hidden sm:block text-[11px] font-medium text-foreground/70 truncate max-w-[80px]">
