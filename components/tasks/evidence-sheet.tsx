    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Upload proof of compliance for "{task.title}".
          </SheetDescription>
        </SheetHeader>
        ...
        <div className="mt-8 space-y-6">
          {/* Upload Box */}
          <div
            className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center transition-all group relative ${
              showSuccess
