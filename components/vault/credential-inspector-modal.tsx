  ...
  return (
    <div className="fixed inset-0 z-[var(--z-tour)] flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div
        ...
        className="w-full max-w-6xl h-[92vh] sm:h-[90vh] bg-popover rounded-t-[3rem] sm:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row"
      >
        ...
        <div className="flex-1 bg-muted relative overflow-hidden flex items-center justify-center p-6 sm:p-8 border-b md:border-b-0 md:border-r border-border min-h-[240px]">
          <div className="absolute top-6 left-6 z-10">
            <span className="px-3 py-1.5 bg-surface-2 text-xs font-semibold uppercase tracking-widest rounded-lg border border-border shadow-sm flex items-center gap-2">
          ...
          <iframe
            src={signedUrl || ''}
            className="w-full h-full rounded-2xl shadow-lg bg-surface-2 border border-edge-2"
        ...
        <div className="w-full md:w-[400px] flex flex-col justify-between p-6 sm:p-10 bg-popover">
          <div className="space-y-10">
            ...
            <div className="p-6 bg-info/10 border border-info/20 rounded-3xl space-y-3">
              ...
              <p className="text-xs text-info leading-relaxed font-medium">
          ...
          <div className="space-y-3 pt-10">
            <div>
              ...
              <textarea
                ...
                className="w-full min-h-[80px] rounded-xl border border-border bg-surface-1 px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground/60"
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={loading}
                className="flex-1 py-4 rounded-2xl border border-destructive/20 bg-destructive/10 text-destructive text-xs font-black uppercase tracking-widest hover:bg-destructive/20 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className={`flex-[2] py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-xl motion-safe:active:scale-95 ${blocked ? 'bg-surface-2 text-muted-foreground cursor-not-allowed' : 'bg-foreground text-background hover:opacity-90'}`}
                title={
                  blocked
