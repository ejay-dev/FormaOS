...
export function ActivityItem({
  ...
  return (
    <div
      ...
      className="group rounded-[1.75rem] border border-white/10 bg-white/[0.04] px-5 py-4 transition hover:border-sky-400/20 hover:bg-white/[0.06]"
    >
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {groupedCount && groupedCount > 1 && (
              <span className="rounded-full border border-white/10 bg-white/[0.06] px-2 py-0.5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-300">
                {groupedCount} events
              </span>
            )}
            {delta != null && (
