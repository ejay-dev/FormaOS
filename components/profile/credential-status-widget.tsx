    ...
    <div className="bg-glass-strong border border-glass-border rounded-[2.5rem] p-8 shadow-sm space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-emerald-400/10 rounded-2xl p-4 border border-emerald-400/30 text-center">
          ...
          <p className="text-[8px] font-black uppercase text-emerald-300 tracking-tighter mt-1">
            Verified
          </p>
        </div>
        <div className="bg-sky-500/10 rounded-2xl p-4 border border-sky-400/30 text-center">
          ...
          <p className="text-xl font-black text-sky-300 leading-none">
            {stats.pending}
          </p>
          <p className="text-[8px] font-black uppercase text-blue-600 tracking-tighter mt-1">
            Pending
          </p>
        </div>
        <div className="bg-red-50 rounded-2xl p-4 border border-red-100 text-center">
          ...
          <p className="text-[8px] font-black uppercase text-red-600 tracking-tighter mt-1">
            Rejected
          </p>
        </div>
      </div>
