...
import { Inter, Sora, JetBrains_Mono, Source_Serif_4 } from 'next/font/google';
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${inter.variable} ${sora.variable} ${jetbrainsMono.variable} ${sourceSerif.variable}`}
    >
