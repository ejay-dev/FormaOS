...
export default async function AuditorAccessPage({
  ...
  return (
    <SettingsPageShell>
      ...
      {/* Kept through the design-system refactor: both revoke paths above still
          redirect with ?error=..., so removing this banner would make a failed
          revoke silently do nothing on screen. */}
      {error && (
