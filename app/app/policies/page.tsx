...
export default async function PoliciesPage() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* Policies List */}
      <div className="bg-gradient-to-br from-[#0B1220] via-[#0E1526] to-[#0A101C] border border-white/10 rounded-2xl shadow-[0_24px_70px_rgba(0,0,0,0.45)] overflow-hidden">
         {/* Simple Toolbar */}
