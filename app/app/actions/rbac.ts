...
const ROLE_PERMISSIONS: Record<RoleKey, PermissionKey[]> = {
  ...
  STAFF: ["VIEW_CONTROLS", "UPLOAD_EVIDENCE", "USE_AI_ASSISTANT"],
  VIEWER: ["VIEW_CONTROLS", "EXPORT_REPORTS", "VIEW_AUDIT_LOGS", "USE_AI_ASSISTANT"],
  AUDITOR: ["VIEW_CONTROLS", "EXPORT_REPORTS", "VIEW_AUDIT_LOGS", "USE_AI_ASSISTANT"],
};
