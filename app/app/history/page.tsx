...
export default async function HistoryPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Compliance History</h1>
                ...
                <div className="bg-white/5 p-5 rounded-2xl border border-white/10 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex items-center gap-2 mt-3 pt-3 border-t border-white/10">
                        ...
                        <span className="text-xs text-muted-foreground">
                            Action performed by <span className="font-medium text-foreground">{log.actor_email ?? "System"}</span>
                        </span>
                    </div>
                </div>
            </div>
