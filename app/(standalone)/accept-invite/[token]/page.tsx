      ...
      <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))] p-6">
        <div className="max-w-md w-full">
          <div className="bg-white/5 rounded-2xl p-8 border border-white/10 text-center">
            <div
              className={`mx-auto w-20 h-20 rounded-full ${iconBg} flex items-center justify-center mb-6`}
            >
              {icon}
            </div>
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/app"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[hsl(var(--card))] text-white rounded-xl font-semibold hover:brightness-110 transition-all"
              >
                Go to Dashboard
              </Link>
              <Link
                href="/auth/signout"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/5 text-slate-200 rounded-xl font-semibold hover:bg-white/10 transition-all"
              >
                Sign Out
              </Link>
            </div>
        ...
        <div className="max-w-md w-full">
          <div className="bg-white/5 rounded-2xl p-8 border border-white/10 text-center">
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/auth/signin"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 text-white rounded-xl font-semibold hover:brightness-110 transition-all"
              >
      ...
      <div className="max-w-md w-full">
        <div className="bg-white/5 rounded-2xl p-8 border border-white/10 text-center">
          ...
          <div className="animate-pulse">
            <Link
              href="/app"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 text-white rounded-xl font-semibold hover:brightness-110 transition-all"
            >
              Go to Dashboard
