...
function SignInContent() {
  ...
  const handleGoogleIdTokenSuccess = useCallback(() => {
    ...
    window.location.href = `${base}/auth/callback?setup=1`;
  }, []);
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8">
            ...
            {/* Google Sign In - Primary CTA
                Uses Google Identity Services (signInWithIdToken) so the consent
                screen shows "FormaOS" instead of the Supabase project URL.
                Falls back to signInWithOAuth if GIS script fails to load. */}
            {!gsiUnavailable ? (
              <div className="mb-6">
                <GoogleOneTap
