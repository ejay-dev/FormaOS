...
import { getIntegrationEventHistory, type IntegrationType } from '@/lib/integrations/manager';
...
export async function GET(request: Request, context: RouteContext) {
  ...
  const history = await getIntegrationEventHistory(auth.context.orgId, integrationId, limit);
