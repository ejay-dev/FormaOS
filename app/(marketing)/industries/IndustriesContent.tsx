...
const industries = [
  ...
  },
  {
    ...
    description:
      'Safeguarding requirements, staff clearance tracking, and evidence for regulatory reviews',
    color: 'cyan' as const,
  },
  {
    icon: Building,
...
const solutions = [
  ...
  },
  {
    ...
    solution:
      'Map standards to tasks and evidence so governance teams can demonstrate compliance quickly',
  },
  {
    problem: 'Safeguarding blind spots',
    solution:
      'Track clearances, training, and incident evidence with audit-ready reporting for regulators',
  },
  {
          ...
          <SectionHeader
            ...
            title={
              <>
                ...
                <span className="text-gradient-system">for your sector</span>
              </>
            }
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg sm:text-xl text-foreground/70 mb-8 sm:mb-10 max-w-2xl mx-auto">
                  Configure custom control libraries, evidence types, and
                  reporting outputs inside FormaOS.
                </p>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                  <Link
                    href="/contact"
                    className="group inline-flex items-center gap-2 mk-btn mk-btn-primary text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 shadow-premium-xl w-full sm:w-auto justify-center"
                  >
                    Contact Sales
