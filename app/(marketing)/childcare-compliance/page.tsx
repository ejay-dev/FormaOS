...
export const metadata: Metadata = {
  title: 'Childcare Compliance Software | FormaOS',
  description:
    'Track NQF, ACECQA, and child safety obligations. Manage policies, evidence, incidents, and staff records across services in one audit-ready platform.',
  keywords: [
  ...
  openGraph: {
    title:
      'Childcare Compliance Software | FormaOS',
    description:
