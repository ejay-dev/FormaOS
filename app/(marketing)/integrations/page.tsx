...
export default function IntegrationsPage() {
  return (
    <MarketingPageShell>
      <CompactHero
        title="Integrations"
        description="Embed compliance into the tools your team already uses. Integrates with Jira, Slack, Teams, Okta, Azure AD, AWS, GitHub, and 5,000+ apps via Zapier."
        topColor="cyan"
        bottomColor="blue"
      />
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 rounded-2xl border border-white/[0.08] bg-white/[0.04] p-8">
          ...
          <p className="text-sm text-slate-300 leading-relaxed mb-6 max-w-3xl">
            FormaOS integrations capture compliance evidence from your existing
            tools and feed it into the evidence vault with full chain-of-custody
            metadata. Every integration record includes the source system,
            timestamp, actor identity, and the control or framework requirement
            it satisfies.
          </p>
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Read-only data collection from connected systems. FormaOS pulls
                evidence artifacts (logs, approvals, configurations) and stores
                them as immutable compliance records with source metadata.
              </p>
            </div>
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              <div className="text-xs font-semibold uppercase tracking-wider text-teal-400 mb-2">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Real-time event notifications from external tools. When a Jira
                ticket closes, a PR merges, or a training completes, FormaOS
                receives the event and records it against the relevant control.
              </p>
            </div>
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5">
              <div className="text-xs font-semibold uppercase tracking-wider text-teal-400 mb-2">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                FormaOS exposes a REST API for custom integrations. Query audit
                logs, compliance status, evidence records, and tasks
                programmatically. Webhook endpoints provide real-time event
                subscriptions.
              </p>
            </div>
          </div>
        ...
        <div className="mb-12 flex flex-wrap items-center gap-4 text-xs text-slate-400">
          ...
          <span>
            {INTEGRATIONS.length} total integrations across {CATEGORIES.length}{' '}
            categories
          </span>
        </div>
                  ...
                  return (
                    ...
                    >
                      <div className="mb-4 flex items-center justify-between">
                        <div
                          className={`flex h-10 w-10 items-center justify-center rounded-xl text-sm font-bold ${integration.color}`}
                        >
