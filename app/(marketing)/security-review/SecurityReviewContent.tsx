...
export default function SecurityReviewContent() {
  return (
    <MarketingPageShell>
      {/* Hero */}
      <section className="relative mx-auto max-w-7xl px-4 pb-14 pt-28 sm:px-6 lg:px-8 lg:pb-18 lg:pt-36 overflow-hidden">
        <HeroAtmosphere topColor="rose" bottomColor="blue" />
        <CursorTilt intensity={3} glowFollow glowColor="251,113,133" className="relative z-10">
