...
export const alt = 'FormaOS vs Vanta — Compliance Platform Comparison';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 720 }}>
            Operational governance and defensible evidence versus automated compliance monitoring. See which platform is built for regulated industries.
          </div>
        </div>
