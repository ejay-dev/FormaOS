...
export const alt = 'FormaOS vs Secureframe — Compliance Platform Comparison';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#ffffff', fontSize: 54, fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', maxWidth: 860 }}>
            FormaOS vs Secureframe
          </div>
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 720 }}>
            Operational governance with defensible evidence versus security compliance automation. Built for regulated industries.
          </div>
        </div>
