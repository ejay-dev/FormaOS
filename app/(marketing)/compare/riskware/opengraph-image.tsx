...
export const alt = 'FormaOS vs Riskware — Compare Compliance Platforms';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            Operational compliance execution vs traditional GRC — see why Australian providers choose FormaOS.
          </div>
        </div>
