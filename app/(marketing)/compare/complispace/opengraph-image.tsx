...
export const alt = 'FormaOS vs CompliSpace — Compare Compliance Platforms';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ color: '#a083ff', fontSize: 14, fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
            Platform Comparison
          </div>
          ...
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            Operational compliance infrastructure vs policy management — see the difference for Australian providers.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ color: '#475569', fontSize: 15 }}>Compare platforms</div>
        </div>
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(160,131,255,0.10) 0%, transparent 70%)',
        }} />
      </div>
    ),
    { ...size },
