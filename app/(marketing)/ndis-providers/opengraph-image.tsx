...
export const alt = 'NDIS Compliance Software — Practice Standards & Audit Ready | FormaOS';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#ffffff', fontSize: 52, fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', maxWidth: 820 }}>
            NDIS Practice Standards & Audit-Ready Compliance
          </div>
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            Structured controls, evidence collection, and real-time audit readiness for NDIS providers.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ color: '#475569', fontSize: 15 }}>NDIS Practice Standards · Quality Indicators · Audit Evidence</div>
        </div>
