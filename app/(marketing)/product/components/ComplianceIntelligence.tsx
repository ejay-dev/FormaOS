...
export function ComplianceIntelligence() {
  return (
    <section className="product-section product-section--core relative py-16 sm:py-24 lg:py-32 overflow-hidden">
          ...
          >
            {intelligenceFeatures.map((feature) => {
              ...
              return (
                <div
                  key={feature.label}
                  className="product-panel product-panel--interactive backdrop-blur-xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] rounded-2xl border border-white/10 p-5 hover:border-green-500/30 transition-all"
                >
