...
export const alt = 'What is a Compliance Operating System? | FormaOS';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            The infrastructure layer that turns compliance from reactive paperwork into provable, continuous operations.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ color: '#475569', fontSize: 15 }}>Learn more</div>
        </div>
