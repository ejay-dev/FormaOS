  ...
  return (
    <MarketingPageShell>
      <div className="relative isolate overflow-hidden">
        <SectionMedia
          src="/marketing-media/what-is-a-compliance-operating-system.jpg"
      ...
      <section className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <ScrollReveal variant="fadeUp" range={[0, 0.3]}>
          <div className="space-y-6 text-base leading-relaxed text-slate-300">
            ...
            <p>
              Think of it like this: a word processor helps you write policies.
              A project management tool helps you assign tasks. A compliance
              operating system connects policies to tasks, tasks to evidence,
              evidence to controls, and controls to regulatory requirements -
              creating a continuous, defensible chain of accountability.
            </p>
            <p>
        ...
        <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-400">
              A compliance operating system has five defining characteristics
              that distinguish it from traditional compliance tools.
            </p>
          </div>
        ...
        <section className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-10 border-b border-white/[0.06] pb-8">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-400">
              How operational compliance compares to GRC tools, spreadsheets,
                  ...
                  {[
                    {
                      ...
                      formaos: 'Continuous operational execution',
                      traditional: 'Periodic documentation and review',
                    },
                    {
                      feature: 'Evidence collection',
                      formaos: 'Automatic, real-time capture',
                      traditional: 'Manual, retroactive gathering',
                    },
                    {
                      feature: 'Audit readiness',
                      formaos: 'Always ready, generate on demand',
                      traditional: 'Requires weeks of preparation',
                    },
                    {
                      feature: 'Control execution',
                      formaos: 'Enforced through workflows',
                      traditional: 'Documented but not enforced',
                    },
                    {
                      feature: 'Accountability',
                      formaos: 'Explicit ownership with tracking',
                      traditional: 'Assigned but not verified',
                    },
                    {
                      feature: 'Multi-framework',
                      formaos: 'Unified controls, shared evidence',
                      traditional: 'Separate tracking per framework',
                    },
                    {
                      feature: 'Compliance gaps',
                      formaos: 'Detected in real-time',
                      traditional: 'Found during periodic reviews',
                    },
                    {
                      feature: 'Staff impact',
                      formaos: 'Embedded in daily workflows',
                      traditional: 'Separate compliance activities',
                    },
                  ].map((row, idx, arr) => (
                    <tr
                      key={row.feature}
        ...
        <section className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          <ScrollReveal variant="fadeUp" range={[0, 0.3]}>
            <div className="space-y-6 text-base leading-relaxed text-slate-300">
              ...
              <p>
                Compliance technology has evolved through three generations. The
      ...
      <DeferredSection minHeight={200}>
        <section className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                label: 'FormaOS Platform',
                href: '/product',
                description: 'See the compliance operating system in action.',
              },
              {
                label: 'ISO 27001 Compliance',
                href: '/iso-compliance-software',
                description: 'How FormaOS automates ISO compliance.',
              },
              {
                label: 'SOC 2 Automation',
                href: '/soc2-compliance-automation',
                description: 'Continuous SOC 2 Type II compliance.',
              },
              {
                label: 'NDIS Compliance',
                href: '/ndis-providers',
                description: 'Purpose-built for disability service providers.',
              },
              {
                label: 'Healthcare Compliance',
                href: '/healthcare-compliance',
                description: 'Clinical governance and accreditation.',
              },
              {
