...
export default function FeaturesPage() {
  return (
    <>
      ...
      <KeyFacts
        summary="FormaOS ships 8 framework packs with 252 mapped controls — ~85 auto-evaluate nightly against your live data, ~167 surface as human attestations. All numbers below trace to lib/compliance/evaluators/register.ts."
        facts={[
          ...
          { label: 'Audit chain', value: 'HMAC-chained audit_log + Sigstore Rekor anchor at 05:30 UTC + append-only Postgres RLS' },
