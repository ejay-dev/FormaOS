...
export const alt = 'Trust & Compliance | FormaOS';
    ...
    (
      ...
      >
        <div style={{ display: 'flex', width: '100%', alignItems: 'center', gap: 16 }}>
          <div style={{ width: 40, height: 40, borderRadius: 10, background: '#2dd4bf', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ color: '#2dd4bf', fontSize: 14, fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
            Trust Centre
          </div>
          <div style={{ color: '#ffffff', fontSize: 54, fontWeight: 800, lineHeight: 1.1, letterSpacing: '-0.03em', maxWidth: 820 }}>
            Trust & Compliance at FormaOS
          </div>
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            Security posture, compliance certifications, and data protection practices — transparent by default.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ color: '#475569', fontSize: 15 }}>ISO 27001 · SOC 2 · Essential Eight</div>
        </div>
