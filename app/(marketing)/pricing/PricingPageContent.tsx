...
const pricingTiers = [
  ...
  },
  {
    ...
    features: [
      ...
      'Secure evidence vault with SHA-256 integrity & audit trails',
      'Workflow automation engine (5 triggers, conditional logic)',
      'Patient management system with risk levels & care episode tracking',
      'Progress notes with automatic compliance evidence generation',
      'Multi-organization management',
      'Real-time notifications & activity monitoring',
      'Priority support',
    ],
    useCase:
      'You must reduce audit effort, automate controls, manage compliance across teams, and streamline healthcare operations.',
    cta: 'Start Free Trial',
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  drata: '❌ None',
                  servicenow: '✅ Add-on',
                  feature: 'Progress Notes & Auditable Care Documentation',
                },
                {
                  formaos: '✅ Included',
                  drata: '❌ None',
