...
import { DollarSign, Target, Users, Shield, Sparkles, Mail, Phone, MapPin, Check } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description: "Simple, transparent pricing for compliance teams. Start free, scale as you grow.",
  alternates: {
    canonical: `${siteUrl}/pricing`,
  },
  openGraph: {
    title: "FormaOS | Pricing",
    description: "Transparent pricing for compliance management. Free trial, no setup fees, cancel anytime.",
    type: "website",
    url: `${siteUrl}/pricing`,
  },
};
            ...
            {plans.map((plan, idx) => (
              <div 
                ...
                className={`bg-background border rounded-xl p-8 relative ${
                  plan.popular ? 'border-primary scale-105 ring-1 ring-primary/20' : 'border-border'
                }`}
              >
                {plan.popular && (
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-foreground/80 mt-4">{plan.description}</p>
                </div>
