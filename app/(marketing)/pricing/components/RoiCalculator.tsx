    ...
    <div className="mx-auto grid max-w-6xl grid-cols-1 gap-x-14 gap-y-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
      ...
      <div>
        ...
        <button
          ...
          className="mt-7 text-[11px] font-semibold text-zinc-500 transition hover:text-zinc-300"
        >
        ...
        <div className="mt-7 space-y-3 border-t border-white/[0.08] pt-6">
          <div>
            <div className="mb-1.5 flex items-center justify-between text-[12px]">
              <span className="text-zinc-400">Compliance run manually</span>
              <span className="font-mono tabular-nums text-zinc-300">{fmtUsdFull(result.manualCost)}/yr</span>
            </div>
            <div className="h-2 overflow-hidden rounded-full bg-white/[0.06]">
              <div className="h-full rounded-full bg-zinc-500/70" style={{ width: '100%' }} />
            </div>
          </div>
          <div>
            <div className="mb-1.5 flex items-center justify-between text-[12px]">
              <span className="text-zinc-400">
                With FormaOS{' '}
                <span className="text-zinc-600">({result.planName} + residual hours)</span>
              </span>
