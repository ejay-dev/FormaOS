export const PRICING_FAQS = [
  {
    ...
    answer:
      'Most registered NDIS providers with 10 to 25 staff start on Growth ($797/mo). It includes 4 compliance frameworks, up to 3 sites, full workflow enforcement, pre-built NDIS Practice Standards, and worker-screening alerts. That covers everything you need to be audit-ready for the Commission. Foundation ($297/mo) suits very small providers (sole-trader and micro-providers, single site, fewer than 10 staff) just moving off spreadsheets. Scale ($1,800/mo) is for multi-site NDIS networks running compliance across many teams.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Upgrades are one click from inside FormaOS and are pro-rated automatically by Stripe. Your data, evidence trail, frameworks, and audit log are preserved when you change plans. You can move up from Foundation to Growth to Scale at any time. To move to Enterprise, contact us so we can scope SSO, directory sync, custom frameworks, and any procurement requirements.',
  },
  {
    question: 'Is there a free trial?',
    answer:
      'No. Foundation, Growth, and Scale require Stripe Checkout immediately on signup, so you pay before you can use the platform. Enterprise evaluations include a guided product walkthrough, a security review pack, and a sandbox tenant for the procurement team, arranged through sales.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "Care management platforms like Brevity and CareMaster handle rostering, billing, and NDIS claims. They are operations tools, not compliance systems. Enterprise GRC platforms like Ideagen Policy Logic (formerly CompliSpace) cost $15,000 to $50,000+ a year and are built for large enterprises. FormaOS sits in the gap: purpose-built compliance infrastructure for Australian NDIS, aged care, and healthcare providers, at a price that works whether you are a sole-trader or a multi-site network.",
  },
  {
    question: 'What happens during an audit or Commission review?',
    answer:
      'You can export evidence trails, workflow completion history, control status, approver context, and the full audit log directly from FormaOS. The goal is to show what happened, who approved it, when it happened, and why the evidence is trustworthy. That is exactly what the NDIS Commission, the Aged Care Quality and Safety Commission, and accreditation bodies require.',
  },
  {
