...
function ContactHeroVisualInner() {
  ...
  return (
    <div className="pointer-events-none hidden lg:flex h-[480px] w-[460px] items-center justify-center">
      <div className="relative h-[480px] w-[460px]">
        <motion.div
          className="absolute left-0 top-0 w-[280px] rounded-[28px] border border-white/10 bg-[linear-gradient(160deg,rgba(10,15,28,0.94),rgba(12,20,38,0.84))] p-6 shadow-[0_28px_90px_rgba(3,7,18,0.45)] backdrop-blur-xl"
        ...
        <motion.div
          className="absolute right-0 top-0 w-[160px] rounded-[24px] border border-white/10 bg-white/[0.06] p-4 backdrop-blur-xl"
        ...
        <motion.div
          className="absolute bottom-0 right-0 w-[160px] rounded-[24px] border border-white/10 bg-[linear-gradient(160deg,rgba(34,211,238,0.16),rgba(15,23,42,0.72))] p-4 shadow-[0_20px_60px_rgba(8,47,73,0.35)] backdrop-blur-xl"
