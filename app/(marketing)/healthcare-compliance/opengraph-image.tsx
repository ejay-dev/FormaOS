...
export const alt = 'Healthcare Compliance Software — AHPRA, NSQHS & Clinical Governance | FormaOS';
    ...
    (
      ...
      >
        <div style={{ display: 'flex', width: '100%', alignItems: 'center', gap: 16 }}>
          <div style={{ width: 40, height: 40, borderRadius: 10, background: '#34d399', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ color: '#34d399', fontSize: 14, fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 22, lineHeight: 1.5, maxWidth: 700 }}>
            Continuous compliance for healthcare providers — NSQHS standards, AHPRA registration, and clinical governance.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ color: '#475569', fontSize: 15 }}>NSQHS · AHPRA · Clinical Governance</div>
        </div>
