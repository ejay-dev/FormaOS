...
const roadmapItems: RoadmapItem[] = [
  ...
  {
    title: 'Evidence Auto-Collection via Cloud APIs',
    description:
  ...
  {
    title: 'Compliance Q&A Assistant (general-purpose)',
    description:
    ...
    capabilities: [
      ...
      'Org-grounded RAG: planned, not shipping',
    ],
  },
  {
            ...
            <div className="relative p-8 sm:p-12 lg:p-16 text-center">
              <ScrollReveal variant="depthScale" range={[0, 0.3]}>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <a
                    href="mailto:support@formaos.com.au?subject=Feature%20Request"
