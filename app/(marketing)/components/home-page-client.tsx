        ...
        <ParallaxLayer speed={0.3}>
          <div className="mx-auto max-w-4xl text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 sm:gap-2.5 glass-intense rounded-full px-4 sm:px-6 py-2 sm:py-3 text-[10px] sm:text-xs font-semibold mb-6 sm:mb-8 border border-secondary/30"
            >
              <motion.div
            ...
            >
              Turn compliance chaos into defensible workflows. Connect policies,
              evidence, and audit trails into a single platform designed for
              regulated teams.
            </motion.p>
    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            { value: '70+', label: 'Pre-built Controls' },
          ...
          {[
            {
              title: 'Policy Engine',
              description:
                'Version-controlled policies with review cadence, ownership, and staff acknowledgement tracking.',
            },
            {
              title: 'Task Management',
              description:
                'Turn controls into tasks with due dates, assignees, and accountability chains.',
            },
            {
            ...
            },
            {
              ...
              description:
                'Executive dashboards, risk summaries, and readiness reports in minutes.',
            },
          ].map((feature, idx) => (
            <div
              key={idx}
