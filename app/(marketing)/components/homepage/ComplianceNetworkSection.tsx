      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <ScrollReveal variant="blurIn" range={[0, 0.3]} className="mb-10 text-center lg:mb-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-4 lg:gap-6">
            {legendItems.map((item) => (
              <div
                key={item.label}
                className="home-panel home-panel--soft flex items-center gap-2.5 rounded-xl px-3 py-2 sm:gap-3 sm:px-4 sm:py-2.5"
              >
        ...
        <ScrollReveal variant="fadeUp" range={[0, 0.35]}>
          <div className="mb-4 grid gap-2 sm:hidden">
            <div className="home-panel home-panel--soft rounded-xl border border-teal-400/15 bg-slate-950/60 px-4 py-2.5 text-left backdrop-blur-md">
            ...
            <div className="home-panel home-panel--soft rounded-xl border border-indigo-400/20 bg-slate-950/60 px-4 py-2.5 text-left backdrop-blur-md">
          ...
          <div className="home-panel home-panel--strong relative min-h-[420px] overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-gray-950/80 via-[#070d1f] to-[#050812] shadow-2xl shadow-black/30 aspect-[4/3] sm:min-h-[500px] sm:aspect-[16/11] lg:min-h-0 lg:aspect-[16/7]">
          ...
          <div className="mt-5 text-center">
            <p className="inline-flex rounded-full border border-white/10 bg-slate-950/50 px-4 py-2 text-xs text-slate-400 sm:text-sm">
