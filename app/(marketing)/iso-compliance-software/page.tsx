...
const pageFaq = [
  {
    question: 'Does FormaOS support ISO 27001:2022?',
    answer:
  ...
  {
    question: 'Can FormaOS help with ISO certification?',
    answer:
  ...
  {
    question: 'How does FormaOS handle the Statement of Applicability?',
    answer:
  ...
  {
    question: 'Can we manage multiple ISO frameworks simultaneously?',
    answer:
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            breadcrumbSchema([
              { name: 'Home', path: '/' },
              {
                name: 'ISO Compliance Software',
                path: '/iso-compliance-software',
              },
            ]),
          ]),
        }}
