-- =========================================================
-- ENSURE FORMS PLATFORM SCHEMA
-- Migration: 20260426_001_ensure_forms_platform_schema
--
-- Repair/idempotency pass for environments that missed
-- 20260402_forms_platform.sql. Matches current app expectations:
-- org_forms, org_form_submissions, and org_form_templates.
-- =========================================================
...
begin
  if not exists (
    ...
    where schemaname = 'public' and tablename = 'org_forms' and policyname = 'org_forms_select'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_forms' and policyname = 'org_forms_insert'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_forms' and policyname = 'org_forms_update'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_forms' and policyname = 'org_forms_delete'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_form_submissions' and policyname = 'org_form_submissions_select'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_form_submissions' and policyname = 'org_form_submissions_insert'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_form_submissions' and policyname = 'org_form_submissions_update'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public' and tablename = 'org_form_templates' and policyname = 'org_form_templates_select'
  ) then
