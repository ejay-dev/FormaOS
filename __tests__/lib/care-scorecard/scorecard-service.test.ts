  ...
  describe('generateCareScorecard', () => {
    ...
    it('calculates staff compliance with mixed statuses', async () => {
      ...
      makeAdmin({
        ...
        org_staff_credentials: {
          data: [
            { user_id: 'u1', status: 'verified', expiry_date: future },
            { user_id: 'u2', status: 'expired', expiry_date: past },
            { user_id: 'u2', status: 'verified', expiry_date: future },
    ...
    it('calculates trend as "down" when low percentage', async () => {
      ...
      makeAdmin({
        ...
        org_staff_credentials: {
          data: [
            { user_id: 'u1', status: 'expired', expiry_date: past },
            { user_id: 'u2', status: 'expired', expiry_date: past },
          ],
          error: null,
        },
        ...
        org_staff_credentials: {
          data: [
            ...
            },
            {
              ...
              credential_name: 'Police',
              credential_number: null,
              expiry_date: in80Days,
              status: 'verified',
    ...
    it('handles staff with pending credentials', async () => {
      makeAdmin({
        org_members: { data: [{ id: 'm1', user_id: 'u1' }], error: null },
        org_staff_credentials: {
          data: [{ user_id: 'u1', status: 'pending', expiry_date: null }],
          error: null,
        },
        org_audit_logs: { data: [], error: null },
        org_visits: { data: [], error: null },
    ...
    it('handles credential with status verified but expired date', async () => {
      ...
      makeAdmin({
        org_members: { data: [{ id: 'm1', user_id: 'u1' }], error: null },
        org_staff_credentials: {
          data: [{ user_id: 'u1', status: 'verified', expiry_date: past }],
          error: null,
        },
        org_audit_logs: { data: [], error: null },
        org_visits: { data: [], error: null },
